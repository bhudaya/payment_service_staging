...
class StoreWorkCreditCashClientFactory{
    ...
    public static function buildCashInClient()
    {
        if( self::$_instance_in == NULL )
        {
            ...
            self::$_instance_in = new StoreWorkCreditCashInClient(array(
                'base_url' => $url,
    ...
    public static function buildCashOutClient()
    {
        if( self::$_instance_out == NULL )
        {
            ...
            self::$_instance_out = new StoreWorkCreditCashOutClient(array(
                'base_url' => $url,
                'header' => RequestHeader::get()
            ));
        }
