...
class TransferToPaymentRequestService extends PaymentRequestService{
    ...
    public function _requestAction(PaymentRequest $request)
    {
        ...
        // create sign data
        //$signed_data = $TransferTo_switch_client->generateSignedData('remit');
        //$TransferTo_switch_client->setSignedData($signed_data);

        // create inquiry sign data
        //$inquire_signed_data = $TransferTo_switch_client->generateSignedData('inquiry');
        //$TransferTo_switch_client->setInquireSignedData($inquire_signed_data);
